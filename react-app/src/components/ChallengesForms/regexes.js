const challengeTypeRegex = /collect|craft\b|damage|finish\b|win|restore|revive|resurrect|knockdowns|\bkills|assists|headshots|finishing|loot\b|open\b|play|capture|purchase|upgrade|survey beacons|outlive|survive/g
const abilitiesRegex = /amped cover|knuckle cluster|looted by squadmates|scan\b.*enemies|silence|phase breach|double time|neuro|\bgas\b|bamboozle|nox|rolling thunder/g
