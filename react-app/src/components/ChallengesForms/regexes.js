...
const abilitiesRegex = /nox|thunder|bombardment|gun\bshield|drone|zipline|phase|amped cover|knuckle cluster|looted by squadmates|scan\b.*enemies|silence|double time|decoy|bamboozle|gas|jump pad|missile/
const legendsRegex = /bloodhound|gibraltar|lifeline|pathfinder|wraith|bangalore|caustic|octane|mirage|wattson|crypto|revenant|loba|rampart|horizon|fuse|valkyrie|seer|ash|maggie|newcastle|vantage|beacons/g
