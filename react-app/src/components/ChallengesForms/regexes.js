...
const abilitiesRegex = /nox|thunder|bombardment|gun\bshield|drone|zipline|phase|amped cover|knuckle cluster|looted by squadmates|scan\b.*enemies|silence|double time|decoy|bamboozle|gas|jump pad|/
