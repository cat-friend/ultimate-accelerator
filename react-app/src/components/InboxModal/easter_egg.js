const qqh = {
    2: (<><div className="message">Joseph,</div>

        <div className="message">Literally, you are an inspiration--you inspired this project and you inspire me to be a better person. I really don't
        ...
        <div className="message">This project is a labor of love for you, for all the cool people who I've met through you, and is the, *ahem*, apex
            of
        ...
        <div className="message">Always,<br />
            Denise</div></>),
    3: (<><div className="message">Sean,</div>
        <div className="message">Heeennnnllooo. My pal, Green Pepski, I have the best time with you. You are so fun and kind and caring and I am so
        ...
        <div className="message">Thank you for welcoming me into your life. It has been a real delight to be a part of it and I'm looking forward to
            many, many, manayaamannayayaanamnay more years of kekeing in bideo jems with you and the rest of the pep-peps.</div>

        <div className="message">Please rap battle me some day.</div>
        <div className="message">Always,<br />
            Denise</div></>),
    5: (<><div className="message">Dear Nick,</div>
        <div className="message"><i>Ultimate Accelerator</i>, or as it's known colloquially <i>Dolphismyfriend's apex legends combo wombo app for my
        ...
        <div className="message">Thank you for your openness, poop memes, sexy Shrek gifs, agreeing with me that I'm cute that one time, welcoming me back, and
        ...
        <div className="message">Always,<br />
            Denise</div></>),
    8: (<><div className="message">Umbasa,</div>

        <div className="message">When we first met, you were very quiet. You are still quiet but I appreciate that you have more or less resigned to
        ...
        <div className="message">Thank you for sharing music with me. It really delights me when people share playlists with me because I feel like
        ...
        <div className="message">Always,<br />
            Denise</div></>),
    10: (<><div className="message">Nathan,</div>
        <div className="message">I met Dolph through you. Before Dolph and I first played Apex together, I communicated to him which goons
        ...
        <div className="message">To go through a pandemic is hard. To go through a bootcamp is hard. To go through a divorce is hard. I decided to
            undertake all three simultaneously. I've only been able to get through the hardest periods of my life because of my
